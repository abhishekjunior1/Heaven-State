      ...
      <div>
        ...
        >
          ...
          <div className="w-2/4 max-md:w-full">
            ...
            >
              <p className="text-xl">
              Heaven Estate offers premium real estate solutions, combining luxury and comfort to meet all your housing needs. Our commitment to excellence ensures you find your dream home with us.
              </p>
      ...
      <div className="bg-gray-100">
        ...
        >
          ...
          >
            ...
            <p className="text-xl">
            At Heaven Estate, we specialize in providing exceptional real estate services. From buying and selling properties to offering expert advice and property management, our dedicated team ensures a seamless experience for all your real estate needs. We strive to make your dream home a reality.
            </p>
            <Link onClick={scrollToTop} to={"/about"}>
              <button
          ...
          >
            <div className="flex flex-col gap-7 ">
              <WhatWeDoCard
                ...
                title={"Reliability"}
                desc={
                  "Heaven Estate is your trusted partner, committed to delivering reliable and dependable real estate services."
                }
              />
              <WhatWeDoCard
                ...
                title={"communication"}
                desc={
                  "Effective communication is our cornerstone, ensuring clear and transparent interactions throughout your real estate journey with Heaven Estate."
                }
              />
            </div>
            <div className="flex flex-col gap-7">
              ...
              <WhatWeDoCard
                ...
                title={"Quality First"}
                desc={
                  "We prioritize quality first, ensuring every property and service meets the highest standards of excellence."
                }
              />
              <div
                style={{ height: 130 }}
